...
Component.options.__file = "resources/assets/js/components/locationEntry.component.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2e7f5376", Component.options)
  } else {
    hotAPI.reload("data-v-2e7f5376", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        setLatLon: function setLatLon() {
            this.$root.latitude = this.latitude;
            this.$root.longitude = this.longitude;

            this.$root.getLocations();
        }
    }
});
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-xs-12 col-md-6 form-group" }, [
        ...
        _vm._v(" "),
        _c("div", { staticClass: "col-xs-12 col-md-6 form-group" }, [
          _c("label", { attrs: { for: "latitude" } }, [_vm._v("Longitude")]),
          _vm._v(" "),
          _c("input", {
            directives: [
              {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2e7f5376", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/locationList.component.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-60c22ece", Component.options)
  } else {
    hotAPI.reload("data-v-60c22ece", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['locations'],
    methods: {
        locationClick: function locationClick(location) {
            this.$root.selectLocation(location);
        },
        formatMiles: function formatMiles(value) {
    ...
    [
      _vm.locations.length === 0
        ? _c("dd", { staticClass: "text-center" }, [
            _vm._v("Locating your position to load the nearest pharmacies."),
            _c("br"),
            _vm._v(
              "If you do not allow browser location sharing, please enter your latitude and longitude to find the pharmacy nearest to you."
            )
          ])
        : _vm._e(),
      _vm._v(" "),
      _vm._l(_vm.locations, function(location) {
        return _c(
          "dd",
          { key: location.id, class: { selected: location.isSelected } },
          [
            _c("div", { staticClass: "row" }, [
              ...
              _c("div", { staticClass: "col-xs-3 text-right" }, [
                _vm._v(_vm._s(_vm.formatMiles(location.distance)) + "m")
              ])
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "row" }, [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-60c22ece", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/locationMap.component.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7d478caf", Component.options)
  } else {
    hotAPI.reload("data-v-7d478caf", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
    ...
    watch: {
        locations: function locations(_locations) {
            ...
            if (_locations.length > 2) {
                ...
                try {
                    for (var _iterator = _locations[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        var l = _step.value;
...
var render = function() {
  ...
  return _c(
    "GmapMap",
    {
      ...
      attrs: { zoom: 8, center: { lat: 38.9822, lng: -94.6708 } }
    },
    [
      _c(
        "gmap-info-window",
      ...
      _vm._l(_vm.locations, function(location, index) {
        return _c("GmapMarker", {
          ...
          on: {
            click: function($event) {
              _vm.toggleInfoWindow(location, index)
            }
          }
        })
      })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7d478caf", module.exports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue2_google_maps__ = __webpack_require__(64);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('location-entry', __webpack_require__(252));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('location-list', __webpack_require__(255));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('location-map', __webpack_require__(258));
    ...
    methods: {
        ...
        getLocations: function getLocations() {
            ...
            $.ajax({
                ...
                _this2.locations = _.map(response, function (location) {
                ...
                _this2.selectLocation(_this2.locations[0]);
            }).fail(function (error) {
                console.error(error);
            });
        },
